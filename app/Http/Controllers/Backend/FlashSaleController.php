...
class FlashSaleController extends Controller
{
     ...
     public function update(Request $request)
     {
        ...
        toastr('Updated Successfully!', 'message', 'Success');
     ...
     public function addProduct(Request $request)
     {
        $request->validate([
          ...
          'status' => ['required'],
           ...
           'product.unique' => 'The product is already in flash sale please choose different product!'
        ]);
     ...
     public function changeShowAtHomeStatus(Request $request)
     {
        ...
        return response(['message' => 'Show at Home Status has been updated!']);
     }

     public function changeStatus(Request $request){
        $childCagetory = FlashSaleItem::findOrFail($request->id);
    ...
    public function destroy(string $id)
    {
       ...
       return response(['status' => 'Flash Sale has been Deleted!']);
    }
}
