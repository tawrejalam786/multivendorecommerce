...
class ProductVariantController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        toastr('Product Variant Successfully Created!', 'success', 'success');
    ...
    public function update(Request $request, string $id)
    {
        ...
        // toastr('Product Variant Successfully Updated!', 'success',);
        return redirect()->route('admin.products-variant.index', ['product' => $variant->product_id])->with('success', 'Product Variant Successfully Updated!');
        
    //     return redirect()
    // ->route('admin.products-variant.index', ['product' => $variant->product_id])
    // ->with('reload', true)
    // ->with('success', 'Product Variant Successfully Updated!');
